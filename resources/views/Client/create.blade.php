...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">العملاء</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ اضافة العميل</span>
            </div>
        </div>
                            ...
                            <div class="col-lg-12">
                                <div class="bg-gray-200 p-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="email" placeholder="الايميل" required="" type="email">
                                        @if($errors->has('email'))
                                    ...
                                    <div class="parsley-select wd-250 mg-t-30" id="slWrapper2">
                                        ...
                                        <select class="form-control select2" data-parsley-class-handler="#slWrapper2"
                                                ...
                                                data-placeholder="Choose one"  name="company_id">
