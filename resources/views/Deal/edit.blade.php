    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                ...
                <span class="text-muted mt-1 tx-13 mr-2 mb-0">  تعديل صفقة /{{$deal->title}}  </span>
            </div>
        </div>
    </div>
@endsection
                            ...
                            <div class="panel panel-primary setup-content" id="step-1">
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control required" name="title" placeholder="العنوان" value="{{$deal->title}}" required>
                                    </div>
                                    <div class="form-group">
                                        <label class="form-label">الوصف</label>
                                        <textarea type="text" class="form-control required" name="description"  required>{{$deal->description}}</textarea>
                                    </div>
                                    <div class="form-group">
                                        <label class="form-label">المستخدم مالك الصفقة</label>
                                        <select class="form-control select2" name="user_id" required>
                                            <option label="اختر المستخدم الذي يملك الصفقة" disabled>اختر المستخدم الذي يملك الصفقة</option>
                                            @foreach($users as $user)
                                                <option value="{{$user->id}}" {{ $deal->user_id == $user->id ? 'selected' : '' }}>{{$user->name}}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group mb-0">
                                        ...
                                        <input type="date" class="form-control required" name="expected_time" value="{{$deal->expected_time}}" required>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" name="journey_id" required>
                                            ...
                                            @foreach($journeys as $journey)
                                                <option value="{{$journey->id}}" {{ $deal->journey_id == $journey->id ? 'selected' : '' }}>{{$journey->name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" name="client_id" required>
                                            ...
                                            @foreach ($clients as $client)
                                                <option value="{{$user->id}}" {{ $deal->client_id == $client->id ? 'selected' : '' }}>{{$client->name}}</option>
                                            @endforeach
                                        </select>
