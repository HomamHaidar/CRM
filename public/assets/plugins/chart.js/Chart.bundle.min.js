...
module.exports = {
	...
	modes: {
		...
		/**
		 * Point mode returns all elements that hit testss.blade.php based on the event position
		 * of the event
		...
		/**
		 * x mode returns the elements that hit-testss.blade.php at the current x coordinate
		...
		/**
		 * y mode returns the elements that hit-testss.blade.php at the current y coordinate
...
var helpers = {
	 ...
	 * @param {*} value - The value to testss.blade.php.
	 * @returns {Boolean}
	 * @since 2.7.0
	 */
